...
const Privaty_Unkind_Maid = () => {
  ...
  return (
    <div className="min-h-full bg-[#101633]">
      <Helmet>
        <title>Privaty: Unkind Maid - Shifty.moe</title>
      </Helmet>
        ...
        <div className="container mx-auto max-w-3/4 border-1 bg-[#24285a] xl:p-0 p-4 md:p-0 xl:p-0 2xl:p-0 rounded">
          <div className="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
            ...
            <div className='grid grid-rows-2 grid-flow-col gap-4 sm:grid-rows-none sm:grid-cols-4'>
              ...
              <div className="bg-blue-500 text-white text-sm py-2 px-4 rounded mb-5">
                <div className='flex flex-col items-center mb-3'>
                  <h1 className='font-bold'>Passionate Maid:</h1>
                  <h1 className='font-bold sm:ml-2'>Lv 1</h1>
                </div>
                <span className='text-[#dbddef]'>
                  {skill_1}
              ...
              <div className="bg-blue-500 text-white text-sm py-2 px-4 rounded mb-5">
                <div className='flex flex-col items-center mb-3'>
                  <h1 className='font-bold'>Loving Maid:</h1>
                  <h1 className='font-bold sm:ml-2'>Lv 1</h1>
                </div>
                <span className='text-[#dbddef]'>
                  {skill_2}
              ...
              <div className="bg-blue-500 text-white text-sm py-2 px-4 rounded mb-5">
                <div className='flex flex-col items-center mb-3'>
                  <h1 className='font-bold'>Your Bashful Maid!:</h1>
                  <h1 className='font-bold sm:ml-2'>Lv 1</h1>
                </div>
                <span className='text-[#dbddef]'>
                  {burst_skill}
            ...
            <table class="border-collapse border border-slate-400 ... mt-5">
              <thead>
                <tr>
                <th class="border border-slate-300 ... text-[#ffd780]">Skill&nbsp;1</th>
                  <th class="border border-slate-300 ... text-[#ffd780]">Skill&nbsp;2</th>
              ...
              <tbody>
                <tr>
                  <td class="border border-slate-300 ... text-white text-center">7</td>
                  <td class="border border-slate-300 ... text-white text-center">7</td>
                  <td class="border border-slate-300 ... text-white text-center">7</td>
                  <td class="border border-slate-300 ... text-[#dbddef]">Skill 1 Gives Consistent good damage, with slight wave clear viability Skill 2 Investment Depends if using with Tove/Leona, if not, leave it at level 1. Burst is Good for campaign purposes, higher value if the player has Crit rate rolls on gear.</td>
                </tr>
...
export default Privaty_Unkind_Maid;
