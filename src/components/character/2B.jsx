    ...
    const getCharId = async () => {
      try {
        const response = await axios.get(
          `http://localhost:5000/character/15`
        );
            ...
            <table class="border-collapse border border-slate-400 ... mt-5">
              ...
              <tbody>
                <tr>
                  ...
                  <td class="border border-slate-300 ... text-white">9.5</td>
                  <td class="border border-slate-300 ... text-[#dbddef]">Skill 1 and Skill 2 has pretty horrible scaling, and buff itself is mediocre. Her burst Actually does some good healing.</td>
                </tr>
