    ...
    const getCharId = async () => {
      try {
        const response = await axios.get(
          `http://localhost:5000/character/11`
        );
        ...
        <div className="container mx-auto max-w-3/4 border-1 bg-[#24285a] xl:p-0 p-4 md:p-0 xl:p-0 2xl:p-0 rounded">
          <div className="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
            <div className="flex flex-col sm:flex-row">
              ...
              <div className="flex-grow flex flex-col justify-between">
                ...
                <div className='flex flex-col sm:flex-row items-center gap-4'>
                  ...
                  <div className="bg-teal-700	 text-white text-sm py-2 px-4 rounded">
                         Defender
                  </div>
                </div>
              </div>
            ...
            <div className='grid grid-rows-2 grid-flow-col gap-4 sm:grid-rows-none sm:grid-cols-4'>
              ...
              <div className="bg-blue-500 text-white text-sm py-2 px-4 rounded mb-5">
                <div className='flex flex-col items-center mb-3'>
                  <h1 className='font-bold'>Lucky Guard:</h1>
                  <h1 className='font-bold sm:ml-2'>Lv 1</h1>
                </div>
                <span className='text-[#dbddef]'>
                  {skill_1}
              ...
              <div className="bg-blue-500 text-white text-sm py-2 px-4 rounded mb-5">
                <div className='flex flex-col items-center mb-3'>
                  <h1 className='font-bold'>Rabbit Twins W:</h1>
                  <h1 className='font-bold sm:ml-2'>Lv 1</h1>
                </div>
                <span className='text-[#dbddef]'>
                  {skill_2}
              ...
              <div className="bg-blue-500 text-white text-sm py-2 px-4 rounded mb-5">
                <div className='flex flex-col items-center mb-3'>
                  <h1 className='font-bold'>Showtime:</h1>
                  <h1 className='font-bold sm:ml-2'>Lv 1</h1>
                </div>
                <span className='text-[#dbddef]'>
                  {burst_skill}
            ...
            <table class="border-collapse border border-slate-400 ... mt-5">
              ...
              <tbody>
                <tr>
                  ...
                  <td class="border border-slate-300 ... text-white">4</td>
                  <td class="border border-slate-300 ... text-white">10</td>
                  <td class="border border-slate-300 ... text-[#dbddef]">Skill 1 is a rather weak shield, not worth investing too much skill books in, leave it at lv 3 or 4. Skill 2 is where some of her healing comes from, great in boss fights. fairly low priority to level beyond 4, but levelling it to 7 good if you dont have any higher priority skills. Burst is where her kit becomes pretty insane. Damage taken debuff + more healing. Basically level 10 is required if youre serious about bossing since its in the top 3 strongest support skills in the game.</td>
                </tr>
