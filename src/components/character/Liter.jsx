    ...
    const getCharId = async () => {
      try {
        const response = await axios.get(
          `http://localhost:5000/character/21`
        );
        ...
        <div className="container mx-auto max-w-3/4 border-1 bg-[#24285a] xl:p-0 p-4 md:p-0 xl:p-0 2xl:p-0 rounded">
          <div className="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
            ...
            <div className='grid grid-rows-2 grid-flow-col gap-4 sm:grid-rows-none sm:grid-cols-4'>
              ...
              <div className="bg-blue-500 text-white text-sm py-2 px-4 rounded mb-5">
                <div className='flex flex-col items-center mb-3'>
                  <h1 className='font-bold'>Liter Boost:</h1>
                  <h1 className='font-bold sm:ml-2'>Lv 1</h1>
                </div>
                <span className='text-[#dbddef]'>
                  {skill_1}
              ...
              <div className="bg-blue-500 text-white text-sm py-2 px-4 rounded mb-5">
                <div className='flex flex-col items-center mb-3'>
                  <h1 className='font-bold'>Volt Boost:</h1>
                  <h1 className='font-bold sm:ml-2'>Lv 1</h1>
                </div>
                <span className='text-[#dbddef]'>
                  {skill_2}
              ...
              <div className="bg-blue-500 text-white text-sm py-2 px-4 rounded mb-5">
                <div className='flex flex-col items-center mb-3'>
                  <h1 className='font-bold'>Double Boost:</h1>
                  <h1 className='font-bold sm:ml-2'>Lv 1</h1>
                </div>
                <span className='text-[#dbddef]'>
                  {burst_skill}
            ...
            <table class="border-collapse border border-slate-400 ... mt-5">
              ...
              <tbody>
                <tr>
                  ...
                  <td class="border border-slate-300 ... text-[#dbddef]">Skill 1 and 2 are great and mid-high investments are recommended for both, both greatly increases offensive capability and defensive capabilities for the team. Burst is also great as it does buff b2 and b3 burst AoE /Nuke outputs immensely and scales rather well.</td>
                </tr>
