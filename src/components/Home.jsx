...
function Dashboard() {
  ...
  const handleButtonClick = (classValue) => {
    const newClass = currentClass === classValue ? null : classValue;
    setCurrentClass(newClass);
  };

  const filteredCharacterData = sortedCharacterData.filter(
    (character) => currentClass === null || character.class === currentClass
  );
              ...
              {filteredCharacterData.map((character, index) => (
                ...
                >
                  ...
                  <div className="text-center">
                    <p className="text-sm text-white sm:text-base lg:text-lg xl:text-lg xl:text-sm xl:font-bold xl:text-slate-300">{character.name}</p>
